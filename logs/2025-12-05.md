...
## Leftovers
2025-12-05 [00:59:02] Equalization initated 2025-12-04 20:38 finish, but failed. Reason could be narrow THL range. Next try 1290 to max.
...
- [12:17] Equalization reverted to - Equalization W15-G6_equal-Bonn.h5 (from Markus 2023?)
...
- [14:35] THL Scan for Ne=200e, VtpC 100 VtpF 221 [(221-2*100)*0.5e-3*3e-15/1.602e-19] assuming 0.5 V VtpF DAC. VtpF changed 300-->221. THL Scan 1290-1450, 100 tp, 1/256 column mask [Intermediate run during Noise scan analysis]. Expected THL from AlHe VtpF is 1367.49 THL. Result is broad THL distribution centered at 1350, ie 1348 \pm 58. Noise 6.9\pm0.8 hits. Reference [ThresholdScan](../plots/ThresholdScan_2025-12-05_14-38-03.pdf) [#! THL/Noise pixel distributions show grid like pattern]
- [15:16] THL Scan for large Ne=1000e (Avalache expected). VtpC = 100, VtpF = 307. Expected 1678.12 THL (Scan 1550-1800). Result = 1686 \pm 53 THL. Expected THL. Noise 6.9\pm0.8 hits. Noise pixel distribution is random. Reference [ThresholdScan](../plots/ThresholdScan_2025-12-05_15-20-30.pdf)
- [15:58] VtpF DAC set back to 300 (to makes ure no chages wrt last noise scan). NoiseScan THL 1368 to 1575, shutter 0.01 s. No FPGA overflow, all 65k pixels per THL active and 65k hits per THL. Reference [NoiseScan](../plots/NoiseScan_2025-12-05_16-00-09.pdf). FPGA does not over flow. All pixels have noise, about one hit per pixel.
- [17:07] ~~Test TOT calibration for > 200 e. For TOT calibration from 200 to 4000 electrons, VtpF DAC range is 221.36 to 627.20 for VtpC DAC 100. Mask 4. THL DAC is 1343, below this. Results are noisy but good. Reference [TOTCalibration](../plots/ToTCalib_2025-12-05_17-11-20.pdf)

## Avalanche statistics from Polya Distribution with an assumed shape parameter theta=0.9
...
Reference script [JupyterNotebook](../scripts/Workbook1.ipynb)

## HV connection test
Verifying HV connectivity by setting Vcathode, Vanode, Grid to -10, -15, -20 V respectively
- [17:57] Voltages from the HVunit/HVcables  (Caen Numeric) verified with Brandenburg HV meter
- [18:10] HV Test with GridPix. We will power on GridPix HV at -10,-15,-20 V and LV connected. 
- Invert Vlad suggested Voltage order for similar operating conditions as real. **Vcathode, Vanode, Grid set to -20, -15, -10 V**. Probing with Metex multimeter showed -7.5V and -5V for Vanode and Vgrid, while Vcathode showed -20 V.
- Probing with **Brandenburg HV meter measured correct voltages** -10, -15, -20 V.
- [19:15] Detector left in Orange facility, HV cables attached, HV unit powered off, LV cable disconnected. 
