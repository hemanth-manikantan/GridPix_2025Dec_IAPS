...
- [15:16] To verify AlHe THL Scan for large Ne=1000e (Avalache expected). VtpC = 100, VtpF = 307. Expected 1678.12 THL (Scan 1550-1800). Result = 1686 \pm 53 THL. Expected THL. Noise 6.9\pm0.8 hits. Noise pixel distribution is random. Reference [ThresholdScan](../plots/ThresholdScan_2025-12-05_15-20-30.pdf)
...
- [17:07] Test TOT calibration for > 200 e. For TOT calibration from 200 to 4000 electrons, VtpF DAC range is 221.36 to 627.20 for VtpC DAC 100. Mask 4. Expected threshold from HeAl fit is 1367.49 to 2842.96 THL. THL DAC is 1343, below this. Results are noisy but good. Reference [TOTCalibration](../plots/ToTCalib_2025-12-05_17-11-20.pdf)

## HV test
Verifying HV connectivity by setting Vcathode, Vanode, Grid to -10, -15, -20 V respectively
- [17:57] Voltages from the HVunit/HVcables  (**Add HV unit name later**) verified with Brandenburg HV meter
